...
</li>`).join("");s.insertAdjacentHTML("beforeend",o),new u(".gallery li a",{captions:!0,captionsData:"alt",captionPosition:"bottom",captionDelay:250}).refresh()}const i=document.querySelector(".form"),l=document.querySelector(".loader"),m=document.querySelector(".gallery");i.addEventListener("submit",f);function f(n){n.preventDefault();const s=i.elements[0].value.trim();if(s===""||s.length<3)c.error({title:"",message:"The input field is empty or has less than three characters!"});else{l.style.display="block";const o={key:"45056360-0d73312e4ecad0bc63c18ca30",q:i.elements[0].value.trim(),image_type:"photo",orientation:"horizontal",safesearch:!0};p(o).then(t=>{l.style.display="none",t.hits.length===0?(m.innerHTML="",c.error({title:"",message:"No pictures found! Try again!"})):d(t.hits)}).catch(t=>{l.style.display="none",c.error({title:"",message:`Error fetching images:${t}`})}).finally(()=>i.reset())}}
